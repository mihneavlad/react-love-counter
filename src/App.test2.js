...
describe('App', () => {
  ...
  describe('The rendered `<Counter />` component', () => {
    ...
    xit('has it\'s onIncrement prop set to a function', () => {
      expect(typeof counter.prop('onIncrement')).toBe('function');
    });

    xit('has it\'s onDecrement prop set to a function', () => {
    ...
    describe('onDecrement', () => {
      ...
      xit('cannot decrease the value of counter below 0', () => {
  ...
  describe('The rendered `<Hearts />` component', () => {
    xit('has it\'s count prop set to count from state', () => {
